...
//     triggerOnce: false, // animations will trigger every time it's in view
...
//         <div className="relative rounded-[2.5rem] bg-[#7038f3] text-white p-6 md:p-16 flex flex-col md:flex-row items-center justify-between overflow-hidden">
//           {/* LEFT CONTENT */}
//           <motion.div
...
//             </p>
//             <p className="mt-8 text-2xl font-bold text-white">Elevate your digital presence with</p>
...
//   className="w-full md:w-1/2 mt-16 md:mt-0 relative flex justify-center items-center h-80 md:h-96 overflow-visible"
// >
//   {/* Background images behind phone */}
//   <img
//     src="/public/images/Group 15.png"
//     alt="bg1"
//     className="absolute top-[3px] left-[20px] w-56 md:w-78 z-0 drop-shadow-lg"
//   />
// <img
//   src="/images/Group 18.png"
//   alt="bg2"
//   className="absolute bottom-[-20px] right-[104px] w-40 md:w-52 h-38 md:h-76 z-0 drop-shadow-md object-contain"
// />
...
//       <path
//         d="M315.5 130.5Q299 61 229.5 52.5Q160 44 116.5 89Q73 134 68 197Q63 260 119 299Q175 338 231.5 328Q288 318 333 274Q378 230 347 180.5Q316 131 315.5 130.5Z"
//         fill="#8e6de0"
//         opacity="0.6"
//       />
//       <path
//         d="M261 298.5Q222 347 167 337.5Q112 328 83 283Q54 238 88.5 197Q123 156 166.5 152Q210 148 250 173Q290 198 290.5 248.5Q291 299 261 298.5Z"
//         fill="white"
//         opacity="0.5"
//       />
//     </svg>
...
//   {/* Phone mockup image */}
//   <img
//     src="/images/moblie-removebg-preview.png"
//     alt="Mobile UI"
//     className="relative z-10 w-64 md:w-72 phone-shadow"
//   />
// </motion.div>
...
//         >
//           <button className="w-full md:w-auto px-8 py-4 bg-gradient-to-r from-[#6E38F3] to-[#8659f2] text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-shadow duration-300 text-lg text-center">
