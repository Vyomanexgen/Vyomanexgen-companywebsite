...
//     image: "/images/timetoclimb-3-1.gif", // Updated to .gif
//     icon: <FaBook />,
//   },
//   {
//     id: 2,
...
//   return (
//     <section className="relative pt-36 pb-32 px-4 md:px-20 bg-[#f3f3f3] z-0 overflow-visible" id="PortFolio">
//       <PortfolioHeading />
...
//           <span className="text-lg md:text-2xl lg:text-base font-semibold text-gray-900 text-center" style={{ fontFamily: "Inter, sans-serif" }}>
...
//               <div
//                 key={item.id}
//                 className="relative flex flex-col items-center min-h-[370px] sm:min-h-[380px]"
...
//                       } left-0 w-full z-[1] rounded-xl overflow-hidden shadow-lg bg-white flex justify-center items-center`}
//                       style={{
//                         height: "250px",
//                         maxHeight: "250px",
//                         padding: "8px",
...
//                 {/* Main Card */}
//                 <motion.div
//                   className="relative z-10 bg-[#d0bcff] p-6 rounded-2xl text-white text-center shadow-xl transition-all duration-300 hover:shadow-2xl"
//                   style={{ height: "250px", width: "100%" }}
//                   whileHover={{ y: 55 }}
//                 >
//                   {/* Icon Top Left */}
//                   <div className="text-3xl mb-2 absolute top-4 left-4">
//                     {item.icon}
//                   </div>

//                   {/* Cursor image top right */}
...
//                   {/* Text */}
//                   <div className="flex items-center justify-start gap-4 mt-16 mr-16">
          ...
          {portfolioData.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Card */}
                <motion.div
                  className="relative z-10 bg-[#d0bcff] p-6 rounded-2xl text-white text-center shadow-xl transition-all duration-300 hover:shadow-2xl w-full"
                  style={{ height: "250px" }}
                  whileHover={{ y: 55 }}
                >
                  {/* Top Left Image Icon */}
                 <div className="absolute top-4 left-4 w-8 h-8"> {/* Increased from w-8 h-8 */}
  <img
    src={item.icon}
    alt="icon"
    className="w-full h-full object-contain"
